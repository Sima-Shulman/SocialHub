...
function AlbumPhotos() {
    ...
    return (
        <div className={styles.photosPopup}>
            ...
            {isAdding && (
                <div className={styles.photosActionsBtn}>
                    <input
                        type="text"
            ...
            {!isAdding && <button onClick={() => setIsAdding(true)} className={styles.photosAddButton}>Add New Photo</button>}
                            ...
                            <div key={index} className={styles.photoCard}>
                                ...
                                {editingId === photo.id ? (
                                    ...
                                    <div className={styles.photoTitle}>
                                        ...
                                        <div>{typeof photo.title === 'string' ? photo.title : JSON.stringify(photo.title)}</div>
                                    </div>
                                )}
