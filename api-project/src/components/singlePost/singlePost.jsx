        ...
        <>
            ...
            <div className={styles.postContent}>
                <div className={styles.postText}>
                    {editingId === post.id ? (
                        <div>
                            {/* Input for editing the post title */}
                            #{post.id}:
                            <input
                                type="text"
                    ...
                    {/* Input for editing the post body */}
                    {showBody && (editingId === post.id ? (
                        <textarea
                            ...
                            className={styles.input}
                            rows={4} /* מספר השורות כברירת מחדל */
                        ></textarea>
                    ) : (
                        <span >
            ...
            {
                editingId !== post.id && (
                    <button className={`linkBtns ${styles.viewCommetsBtnLink}`} onClick={() => setSelectedPostId(post.id)}>
                        <Link
